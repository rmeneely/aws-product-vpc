...
vpc = {
  ...
  name = "product-172.21.16.0/20"
}

public_subnets = [
  { # Subnet: product-us-east-1a (public)
    cidr_block = "172.21.16.0/24"
...
k8s_subnets = [
  ...
  { # Subnet: product-us-east-1c (data)
    cidr_block = "172.21.27.0/24"
    availability_zone = "us-east-1c"
    name_tag = "product us-east-1c (k8s)"
  },
  { # Subnet: product-us-east-1d (data)
    cidr_block = "172.21.31.0/24"
    availability_zone = "us-east-1d"
